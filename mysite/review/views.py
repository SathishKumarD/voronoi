...
def get_all_tags(request):
        ...
        response = serializers.serialize('json', tags)
...
class ReviewViewMixin(object):
    ...
    def get_context_data(self, **kwargs):
        context = super(ReviewViewMixin, self).get_context_data(**kwargs)
        context['reviewed_item'] = self.reviewed_item
        return context
    ...
    def get_success_url(self):
        ...
        return "/"+str(self.object.object_id)+"/"
